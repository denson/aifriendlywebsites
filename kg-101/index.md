...
- (the-tour, has-pages, 9)
- (the-tour, ends-at, tour/9-debrief)
- (tour/9-debrief, stays, open-on-screen)
...
- (knowledge-tools, include, "llms.txt + markdown twins + backstage notes + knowledge graphs")
- (knowledge-tools, are, openly-published-never-hidden)
